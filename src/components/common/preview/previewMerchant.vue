<template>
  <!--商家推荐-->
  <div class="preview_merchant item_wrap">
...
<script>
  export default {
    ...
    created() {
      this.merchantDataList = this.merchantData.data;
      this.navBar = this.merchantData.navBar;
    },
    methods: {}
    ,
  }
...
<style lang="scss">
  .preview_merchant {
    ...
    .merchant_content_setting {
      ...
      .swiper-button-next {
        background-image: url("../../../assets/img/preview/button-next.png");
        right: 5px;
        width: 16px;
        height: 31px;
      }
      .swiper-button-prev {
        background-image: url("../../../assets/img/preview/button-prev.png");
        width: 16px;
        height: 31px;
        left: 2px;
      }
